...
criarXlsxPorCliente(
  ...
  List<Map> notas = await pegaNotaPorClienteParaXlsx(
      nomeCliente, listaDataInicial, listaDataFinal, tipoEntidade);

    String tipoEmpresa = tipoEntidade == 0 
    ? "empresaEmissora"
    : "empresaDestinataria";
...
// Save the document.
  ...
  if (selectedDirectory != null) {
    File("$selectedDirectory/Relatório do cliente ${tipoEntidade == 0 ? "ENTRADA" : "SAÍDA"} ${nomeCliente.toUpperCase()}.xlsx")
        .writeAsBytes(bytes);
  }
