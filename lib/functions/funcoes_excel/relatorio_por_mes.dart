...
criarXlsxPorMes(String dataInicial, String dataFinal, int tipoEntidade) async {
  ...
  List<Map> notas =
      await pegaNotaParaXlsx(listaDataInicial, listaDataFinal, tipoEntidade);
...
// Save the document.
  ...
  if (selectedDirectory != null) {
    File("$selectedDirectory/Relatório mensal de ${tipoEntidade == 0 ? "ENTRADA" : "SAÍDA"} ${listaDataInicial[0]}-${listaDataInicial[1]}-${listaDataInicial[2]} até ${listaDataFinal[0]}-${listaDataFinal[1]}-${listaDataFinal[2]}.xlsx")
        .writeAsBytes(bytes);
  }
