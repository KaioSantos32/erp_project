...
class VerTodaNota extends StatelessWidget {
  ...
  Future mostraNotaPesquisada(notaAPesquisar) async {
    // debugPrint(notaAPesquisar["autoEntrada"]);
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Center(
          ...
          style: textHighImportance(font: 42, color: white),
        )),
      ),
      ...
      child: SizedBox(
        ...
        child: Row(mainAxisAlignment: MainAxisAlignment.spaceEvenly, children: [
          ElevatedButton(
            ...
            style: ElevatedButton.styleFrom(
                backgroundColor:
                    notaCancelada == true ? defaultBlue : defaultRed,
                foregroundColor: notaCancelada == true ? darkBlue : darkRed,
                elevation: 5.0),
            child: notaCancelada == true
                ? Text("Reativar Nota", style: textMidImportance(color: white))
                : Text("Cancelar Nota", style: textMidImportance(color: white)),
          ),
          ElevatedButton(
              onPressed: () {
                showDialog(
