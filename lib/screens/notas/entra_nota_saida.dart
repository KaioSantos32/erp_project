...
class EntraNotaSaidaScreen extends StatefulWidget {
  const EntraNotaSaidaScreen({super.key});

  @override
  State<EntraNotaSaidaScreen> createState() => _EntraNotaSaidaScreenState();
}

class _EntraNotaSaidaScreenState extends State<EntraNotaSaidaScreen> {
  var notas = mongoPegaTodasNotas(
      tipoNota: 1, limite: 30, cancelada: false, despesa: false);
              ...
              SizedBox(
                ...
                child: TextField(
                  ...
                  onChanged: (dataInicialInterna) {
                    ...
                    //   dataFinalFormatada = dataFinal.text;
                    // }
                  },
                ),
              ),
  ...
  atualizaTabela(notas) {
    if (txtEditNumeroNota.text != "" ||
      ...
      debugPrint("Pega todas as notas");
